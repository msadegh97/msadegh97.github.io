...
<div class="row">
 ...
 <div class="col-sm mt-3 mt-md-0" style="text-align: center;">
        {% include figure.html path="assets/img/proj1/substruc_moleculenet_fin.png" title="Highlevel vs FG" class="img-fluid rounded z-depth-1" width="400px"%}
    </div>
